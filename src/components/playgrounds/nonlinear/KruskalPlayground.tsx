...
export default function KruskalPlayground({ structure, onOperationChange }: any) {
  ...
  const [edges, setEdges] = useState<GraphEdge[]>([{"source":"A","target":"B","directed":false,"label":"4"},{"source":"A","target":"C","directed":false,"label":"1"},{"source":"C","target":"B","directed":false,"label":"2"},{"source":"B","target":"D","directed":false,"label":"3"},{"source":"C","target":"D","directed":false,"label":"5"}]);
