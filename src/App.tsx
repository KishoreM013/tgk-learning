...
function Footer() { return <footer style={{ borderTop: '1px solid hsl(var(--border))', padding: '22px 0 28px' }}><div className="tgk-shell" style={{ display: 'flex', justifyContent: 'space-between', gap: 15, flexWrap: 'wrap', color: 'hsl(var(--muted-foreground))', fontSize: 12 }}><span>© TGK Learning / made for curious builders</span><span style={{ display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'center', fontFamily: 'var(--app-font-mono)' }}><a href="https://github.com/KishoreM013/tgk-learning" target="_blank" rel="noreferrer" style={{ color: 'hsl(var(--primary))' }}>GitHub repository</a><span>Developed by Kishore Mohan 🐺</span><span>no backend · no account · just practice</span></span></div></footer>; }
